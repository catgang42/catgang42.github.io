...
public class MapGenCaves extends MapGenBase {
	...
	protected void func_870_a(int i, int j, byte abyte0[], double d, double d1, double d2) {
		releaseEntitySkin(i, j, abyte0, d, d1, d2, 1.0F + rand.nextFloat() * 6F, 0.0F, 0.0F, -1, -1, 0.5D);
	}

	protected void releaseEntitySkin(int i, int j, byte abyte0[], double d, double d1, double d2, float f, float f1,
		...
		for (; k < l; k++) {
			...
			for (int k2 = (int) d8; k2 < k1; k2++) {
				...
				label0: for (int k3 = (int) d10; k3 < i2; k3++) {

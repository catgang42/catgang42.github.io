...
public final class EnumArt extends CompatEnum {
	...
	public static EnumArt valueOf(String s) {
		return (EnumArt) CompatEnum.valueOf(EnumArt.class, s);
	}
	...
	static {
		...
		field_1630_D = (new EnumArt[] { Kebab, Aztec, Alban, Aztec2, Bomb, Plant, Wasteland, Pool, Courbet, Sea, Sunset,
				Creebet, Wanderer, Graham, Match, Bust, Stage, Void, SkullAndRoses, Fighters, Pointer, Pigscene,

...
public class RecipesArmor {
	...
	public RecipesArmor() {
		recipeItems = (new Object[][] {
				...
				new Object[] { Item.helmetLeather, Item.helmetChain, Item.helmetSteel, Item.helmetDiamond,
						Item.helmetGold },
				...
				new Object[] { Item.bootsLeather, Item.bootsChain, Item.bootsSteel, Item.bootsDiamond,
						Item.bootsGold } });
	}
		...
		for (int i = 0; i < recipeItems[0].length; i++) {
			...
			for (int j = 0; j < recipeItems.length - 1; j++) {
				...
				craftingmanager.addRecipe(new ItemStack(item),
						new Object[] { recipePatterns[j], Character.valueOf('X'), obj });
			}
	...
	private String recipePatterns[][] = { { "XXX", "X X" }, { "X X", "XXX", "XXX" }, { "XXX", "X X", "X X" },
			{ "X X", "X X" } };

...
public class RecipesDyes {
	...
	public void addRecipes(CraftingManager craftingmanager) {
		...
		craftingmanager.addShapelessRecipe(new ItemStack(Item.dyePowder, 2, 11), new Object[] { Block.plantYellow });
		craftingmanager.addShapelessRecipe(new ItemStack(Item.dyePowder, 2, 1), new Object[] { Block.plantRed });
		craftingmanager.addShapelessRecipe(new ItemStack(Item.dyePowder, 3, 15), new Object[] { Item.bone });

...
public final class EnumToolMaterial extends CompatEnum {
	...
	public static EnumToolMaterial valueOf(String s) {
		return (EnumToolMaterial) CompatEnum.valueOf(EnumToolMaterial.class, s);
	}
	...
	static {
		...
		field_21209_j = (new EnumToolMaterial[] { WOOD, STONE, IRON, EMERALD, GOLD });
	}
}

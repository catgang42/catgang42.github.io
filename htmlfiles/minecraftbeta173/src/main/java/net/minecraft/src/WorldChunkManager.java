...
public class WorldChunkManager {
	...
	public MobSpawnerBase func_4074_a(ChunkCoordIntPair chunkcoordintpair) {
		return func_4073_a(chunkcoordintpair.chunkXPos >> 4, chunkcoordintpair.chunkZPos >> 4);
	}

	public MobSpawnerBase func_4073_a(int i, int j) {
		return func_4069_a(i, j, 1, 1)[0];
	}

	public double func_4072_b(int i, int j) {
		temperature = field_4194_e.func_4112_a(temperature, i, j, 1, 1, 0.02500000037252903D, 0.02500000037252903D,
				0.5D);
	...
	public MobSpawnerBase[] loadBlockGeneratorData(MobSpawnerBase amobspawnerbase[], int i, int j, int k, int l) {
		...
		temperature = field_4194_e.func_4112_a(temperature, i, j, k, k, 0.02500000037252903D, 0.02500000037252903D,
				0.25D);
		humidity = field_4193_f.func_4112_a(humidity, i, j, k, k, 0.05000000074505806D, 0.05000000074505806D,

...
public class Teleporter {
	...
	public boolean func_4106_b(World world, Entity entity) {
		...
		if (d >= 0.0D) {
			...
			System.out.println((new StringBuilder()).append("Teleporting to ").append(d2).append(", ").append(d4)
					.append(", ").append(d6).toString());
						...
						for (int j9 = 0; j9 < 3; j9++) {
							for (int k10 = 0; k10 < 4; k10++) {
								for (int l11 = -1; l11 < 4; l11++) {
									...
									if (l11 < 0 && !world.getBlockMaterial(j12, l12, j13).isSolid()
											|| l11 >= 0 && !world.isAirBlock(j12, l12, j13)) {
										break label0;
									}
								}
						...
						label1: for (int l5 = l1; l5 < l1 + 2; l5++) {
							...
							for (int k9 = 0; k9 < 4; k9++) {
								for (int l10 = -1; l10 < 4; l10++) {
									...
									int k12 = l4 + l10;
									int i13 = k3 + (k9 - 1) * j8;
									if (l10 < 0 && !world.getBlockMaterial(i12, k12, i13).isSolid()
											|| l10 >= 0 && !world.isAirBlock(i12, k12, i13)) {
										break label1;
									}
								}

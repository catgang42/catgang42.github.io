...
public class Item {
	...
	static {
		...
		pickaxeDiamond = (new ItemPickaxe(22, EnumToolMaterial.EMERALD)).setIconCoord(3, 6)
		...
		bucketWater = (new ItemBucket(70, Block.waterStill.blockID)).setIconCoord(11, 4).setItemName("bucketWater")
				.setContainerItem(bucketEmpty);
		bucketLava = (new ItemBucket(71, Block.lavaStill.blockID)).setIconCoord(12, 4).setItemName("bucketLava")
				.setContainerItem(bucketEmpty);
		...
		field_22018_aZ = (new ItemReed(100, Block.field_22021_bh)).setIconCoord(6, 5).setItemName("diode");
	}
}
